...
#### Context Nedir?
    ...
    Uygulamadaki kaynaklara referans olarak her yerden erişmemizi saglayan Android işletim sistemi tarafından 
    implement edilmiş bir Interface'dir. Uygulamanın /res klasöründe bulunan kaynaklara (stringler, resim dosyaları vs.) 
    erişimi sağlamak için kullanılır. Yeni bir Activity başlatma, Intent'leri kullanma gibi işler de Context tarafından yapılır.
